...
#include "../../inc/MarlinConfig.h"
   ...
   */
  #define DMAFT_BUFFER_SIZE_ID 31 // See explanation of this magic number above


  // DMA_FILE_TRANSFER port options for use in DMA mode
  // * DMAFT_XFER_SPD_* Baud rate (2400, 115200, 230400, 460800, 921600)
  // * DMAFT_XFER_PAR_* Parity (NONE, ODD)
  // * DMAFT_XFER_STB_* Stop bits (1, 2)
  #define DMAFT_TRANSFER_PORT_OPTIONS (DMAFT_XFER_SPD_2400_BAUD | DMAFT_XFER_PAR_NONE | DMAFT_XFER_STB_1)

  // DMAFT_TRANSFER_PORT_TIMEOUT is timeout in 50ms units to assume that Host failed.
  // Half of this timeout is used to start data transfer
  // Quarter of this timeout is used to stop serial transfer
  #define DMAFT_TRANSFER_PORT_TIMEOUT_50MS 20 // = 20 * 50ms = 1000ms

  #define DMAFT_PROTOCOL_VERSION 0x01 //DMAFT Protocol version
  #define DMAFT_CHECKSUM_TYPE DMAFT_CS_FLETCHER16 //DMAFT Checksum type. Use DMAFT_CS_*


  #define DMAFT_BUFFER_SIZE 64 * (DMAFT_BUFFER_SIZE_ID + 1) // This is calculated constantly
  #define DMAFT_TRANSFER_PORT_TIMEOUT 50 * DMAFT_TRANSFER_PORT_TIMEOUT_50MS
  #define DMAFT_BUFFER_LAST_BYTE_IDX DMAFT_BUFFER_SIZE - 1
  ...
  private:
    ...
    static void                 request_send_chunk(MarlinSerial* mSerial, const uint8_t chunk_id);
