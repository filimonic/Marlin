...
#define STRING_CONFIG_H_AUTHOR "(filimonic)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 3 // USART3 on Robin Nano V2 is USB port
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 1 // USART1 on Robin Nano V2 is WiFi port
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 * Flying Bear 5 Note:
 *   Config for 1/1 step (without microsteps) is 5, 5, 25, 25.
 *   So, at *_MICROSTEPS == 32 (in configuration_adv.h), this value should be multiplied by 32
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 818 }
...
#define HOMING_FEEDRATE_MM_M { (50*50), (50*50), (4*60) }
